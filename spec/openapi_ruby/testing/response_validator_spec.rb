...
RSpec.describe OpenapiRuby::Testing::ResponseValidator do
  describe "#validate" do
    it "returns no errors for matching status and schema" do
      response_ctx = OpenapiRuby::DSL::ResponseContext.new(200, "OK")
    ...
    it "skips schema validation when no schema defined" do
      response_ctx = OpenapiRuby::DSL::ResponseContext.new(204, "No Content")
