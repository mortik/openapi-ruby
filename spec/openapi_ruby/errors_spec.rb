...
RSpec.describe OpenapiRuby::Error do
  it "inherits from StandardError" do
    expect(described_class).to be < StandardError
  end
end

RSpec.describe OpenapiRuby::InvalidDocumentError do
...
RSpec.describe OpenapiRuby::DuplicateComponentError do
  it "inherits from Error" do
    expect(described_class).to be < OpenapiRuby::Error
  end
end
