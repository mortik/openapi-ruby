...
RSpec.describe OpenapiRuby::Middleware::ResponseValidation do
  ...
  def build_app(inner_app, mode: :enabled, validate_success_only: false)
    req_mw = OpenapiRuby::Middleware::RequestValidation.new(inner_app, schema_resolver: resolver, mode: :disabled)
